...
import { Lock, Mail, User, Eye, EyeOff, Shield, Zap, Users, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const inputClass = "w-full bg-[#14141f] border border-[#2a2a42] rounded-xl pl-11 pr-4 py-3.5 text-sm text-white placeholder-[#44445a] focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/15 transition-all";
    ...
    <div className="min-h-screen flex bg-[#0d0d14]">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[52%] relative overflow-hidden p-16">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[#9090b0] text-lg leading-relaxed mb-12 max-w-sm">
            Create your account in seconds. Your messages are encrypted before they leave your browser — we never see your content.
          </p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 sm:px-16 lg:px-24 py-12 relative">
        ...
        <div className="w-full max-w-sm relative">
          ...
          <p className="text-[#7070a0] text-sm mb-8">Free forever. No credit card required.</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-[#9090b0] uppercase tracking-widest mb-2">Username</label>
              <div className="relative">
                <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#555575]" />
                <input
                  type="text"
                  value={form.username}
            ...
            <div>
              <label className="block text-xs font-semibold text-[#9090b0] uppercase tracking-widest mb-2">Email address</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-semibold text-[#9090b0] uppercase tracking-widest mb-2">Password</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-semibold text-[#9090b0] uppercase tracking-widest mb-2">Confirm password</label>
              <div className="relative">
                <Lock size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#555575]" />
                <input
